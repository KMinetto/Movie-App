  ...
  <div class="home">
    ...
    <div class="container movies">
      <div id="movie-grid" class="movies-grid">
        <div v-for="(movie, key) in movies" :key="key" class="movie">
          <div class="movie-img">
...
export default {
  ...
  methods: {
    async getMovies() {
      const data = axios.get('https://api.themoviedb.org/3/movie/now_playing?api_key=bf2aa90d91269270e8af9e5fe271122d&language=fr-FR&page=1');
